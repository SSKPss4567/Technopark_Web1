...
class QuestionManager(models.Manager):
    ...
    def get_hot_questions_parameters(self): 
        return ( self.get_queryset() .select_related("user_id", "user_id__userprofile")
                .annotate( tag_names=ArrayAgg("tags__name", distinct=True), nickname=models.F("user_id__userprofile__nickname") ) 
...
class Question(models.Model):
    ...
    answer_count = models.PositiveIntegerField(default=0, verbose_name="Количество ответов")
...
class Answer(models.Model):
    ...
    user_id = models.ForeignKey("auth.User",on_delete=models.CASCADE ,verbose_name='Пользователь')
    question_id = models.ForeignKey("questions.Question",on_delete=models.CASCADE, verbose_name='Вопрос')
    text = models.TextField(verbose_name='Текст')
...
class QuestionLike(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(fields=['user_id', 'question_id'], name='unique_question_like')
        ]
...
class AnswerLike(models.Model):
    ...
    user_id = models.ForeignKey("auth.User", on_delete=models.CASCADE,verbose_name='Пользователь')
    answer_id = models.ForeignKey("questions.Answer", on_delete=models.CASCADE, verbose_name='Ответ')
    class Meta:
